...
Route::middleware(['auth', 'role:admin'])->group(function () {
    ...
    Route::get('/dashboard/laporan', [ReportController::class, 'show'])->name('dataku');
    Route::get('/laporan/download-csv', [ReportController::class, 'download'])->name('laporan.downloadCsv');
    Route::get('/laporan/download-pdf', [ReportController::class, 'printPDF'])->name('laporan.pdf');
